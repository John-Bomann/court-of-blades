...
async function showChatRollMessage(
  ...
  if (BladesHelpers.isAttributeAction(attribute_name)) {
    ...
    result = await renderTemplate("systems/court-of-blades/templates/chat/action-roll.html", {
      rolls: rolls,
      method: method,
  ...
  // Check for Resistance roll
    ...
    result = await renderTemplate("systems/court-of-blades/templates/chat/resistance-roll.html", {
      rolls: rolls,
      method: method,
      roll_status: roll_status,
      attribute_label: attribute_label,
  ...
  // Check for Indugle Vice roll
    ...
    result = await renderTemplate("systems/court-of-blades/templates/chat/vice-roll.html", {
      rolls: rolls,
      method: method,
      roll_status: roll_status,
      attribute_label: attribute_label,
  ...
  // Check for Gather Information roll
    ...
    result = await renderTemplate("systems/court-of-blades/templates/chat/gather-info-roll.html", {
      rolls: rolls,
      method: method,
      roll_status: roll_status,
      attribute_label: attribute_label,
  ...
  // Check for Engagement roll
    ...
    result = await renderTemplate("systems/court-of-blades/templates/chat/engagement-roll.html", {
      rolls: rolls,
      method: method,
      roll_status: roll_status,
      attribute_label: attribute_label,
  ...
  // Check for Asset roll
    ...
    result = await renderTemplate("systems/court-of-blades/templates/chat/asset-roll.html", {
      rolls: rolls,
      method: method,
      roll_status: roll_status,
      attribute_label: attribute_label,
  ...
  // Fortune roll if not specified
    ...
    result = await renderTemplate("systems/court-of-blades/templates/chat/fortune-roll.html", {
      rolls: rolls,
      method: method,
      roll_status: roll_status,
