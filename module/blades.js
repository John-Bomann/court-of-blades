...
Hooks.once("init", async function () {
  ...
  Handlebars.registerHelper(
    ...
    function (parameter_name, type, color, current_value, uniq_id) {
      ...
      html += `<div id="blades-clock-${uniq_id}" class="blades-clock clock-${type} clock-${type}-${current_value}" style="background-image:url('systems/court-of-blades/themes/${color}/${type}clock_${current_value}.svg');">`;
  ...
  Handlebars.registerHelper(
    ...
    function (parameter_name, type, current_value, uniq_id) {
      ...
      // Label for 0
      html += `<label class="clock-zero-label" for="clock-0-${uniq_id}}"><i class="fab fa-creative-commons-zero nullifier"></i></label>`;
      html += `<div id="blades-clock-${uniq_id}" class="blades-clock clock-${type} clock-${type}-${current_value}" style="background-image:url('systems/court-of-blades/themes/black/${type}clock_${current_value}.svg');">`;
